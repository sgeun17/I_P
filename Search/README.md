...
우선 후보 5개와 공통 체크리스트 구조, 3개 항목의 질문 30개를 검토용으로 준비했습니다. [초안 안내](phase2_draft/README.md)와 [질문 검토본](phase2_draft/checklist_review.md)을 확인하세요. 아직 팀 합의 전이며 운영 검색에 적용되지 않습니다.
